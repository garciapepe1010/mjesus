...
GUIFrame::GUIFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_toolBar1->AddTool( wxID_ANY, wxT("Open files"), wxBitmap( wxT("icons/folder30.png"), wxBITMAP_TYPE_ANY ), wxNullBitmap, wxITEM_NORMAL, wxT("Open files"), wxT("Add folder") );
	m_toolBar1->AddTool( wxID_ANY, wxT("Add image"), wxBitmap( wxT("icons/file30.png"), wxBITMAP_TYPE_ANY ), wxNullBitmap, wxITEM_NORMAL, wxT("Add image"), wxT("Add image") );
	m_toolBar1->AddSeparator();
	m_toolBar1->AddTool( wxID_ANY, wxT("Proccess"), wxBitmap( wxT("icons/proccess30.png"), wxBITMAP_TYPE_ANY ), wxNullBitmap, wxITEM_NORMAL, wxT("Proccess"), wxT("Proccess") );
	m_toolBar1->Realize();
	...
	m_listCtrl2 = new wxListCtrl( m_panel1, wxID_ANY, wxDefaultPosition, wxSize( 350,1080 ), wxLC_ICON|wxHSCROLL|wxVSCROLL );
	...
	wxPanel *pPanel = new wxPanel(this, wxID_ANY, wxDefaultPosition,  wxSize(400, 400));
    this->m_canvas = new TestGLCanvas(pPanel, wxID_ANY, wxDefaultPosition,  wxSize(400, 400), 0, _T("TestGLCanvas"), gl_attrib );
